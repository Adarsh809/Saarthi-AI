import os
import gradio as gr
from stt import record_audio, transcribe_with_groq
...
def process_audio_and_chat():
    ...
    while True:
        try:
            ...
            print("Recorded audio exists:", os.path.exists(audio_filepath))
            ...
            voice_of_doctor = text_to_speech(input_text=response, output_filepath="final.mp3")
...
with gr.Blocks() as demo:
    gr.Markdown("<h1 style='color: orange; text-align: center;  font-size: 4em;'> Saarthi – Your Personal AI Assistant</h1>")
